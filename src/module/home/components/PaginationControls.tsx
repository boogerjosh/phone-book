...
const PaginationControls: FC<PaginationControlsProps> = (
  ...
  console.log(contacts.length, 'here 45')
  ...
  return (
    <div className='flex gap-2' style={{display: 'flex', gap: '0.5rem', width: "100%", justifyContent: "flex-end", marginTop: "1rem", alignItems: "center"}}>
      <button
      ...
      <div>
        {page} / {Math.ceil(contacts.length / Number(per_page))}
      </div>
